(() => {
  const root = document.currentScript?.src ? new URL(document.currentScript.src).origin : '';
  const apiBase = document.currentScript?.dataset?.sprApi || root;
